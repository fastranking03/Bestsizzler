      ...
      <div className="w-full h-auto flex justify-center py-5 md:py-0 bg-white rounded-4xl shadow-md">
        ...
        <div className="w-[90%] lg:w-[50%] flex flex-col items-center justify-center">
          <div className="w-full flex flex-col gap-2 justify-center items-center">
            <img
              src="public/sizzlerLogo.png"
              alt="Logo"
              className="w-[160px] mt-6 sm:mt-0 md:w-[200px]"
            />
            <h1 className="w-full px-1 font-[600] text-[28px] md:text-[40px] mb-3 lg:text-center text-left">Welcome to Sizzler</h1>
          </div>
              ...
              <div className="flex w-[48%] gap-1 flex-col">
                ...
                <div className="relative">
                  <select
                    name="title"
                    id="title"
                    className="border border-gray-400 px-3 py-[5px] md:py-[10px] pr-10 rounded-md bg-[#f3f3f3] appearance-none w-full"
                  >
          ...
          <div className="flex items-center w-[95%] lg:w-[65%] py-3 border-t-1 border-[#dddddd] mt-6 justify-between">
            <div>
              <p className="text-[#8f8f8f] text-sm md:text-base">Already have a account?</p>
