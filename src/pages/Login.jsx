...
const Login = () => {
  ...
  return (
    ...
    <div className="flex w-full px-4 md:px-15 h-auto justify-center items-center">
        ...
        >
          <img src="../cherry_1.webp" alt="shape" className="lg:w-[80px] md:w-[70px] sm:w-[60px] w-[60px]"/>
        </motion.div>
      <div className="w-full flex justify-center bg-white rounded-4xl shadow-md">
        <div className="hidden lg:flex w-[50%] items-center">
          <img src="public/signup.png" alt="signupImage"/>
        </div>
        <div className="w-[90%] lg:w-[50%] flex flex-col items-center justify-center">
          <div className="w-full flex flex-col gap-2 items-center">
            <img src="public/sizzlerLogo.png" alt="Logo" className="w-[160px] mt-6 sm:mt-0 md:w-[200px]"/>
            <h1 className="w-full px-1 font-[600] text-[32px] md:text-[40px] mb-3 text-left lg:text-center">Login</h1>
          </div>
          <form className="w-[95%] lg:w-[70%]" onSubmit={loginHandler}>
            ...
            <div className="flex flex-col gap-1 relative">
                <label className="font-base text-[#4D5765] text-base md:text-lg" htmlFor="password">
                  Password
                </label>
            ...
            <div className="w-full flex justify-between items-center pt-2">
              ...
              <Link to="/forgot-password">
                <button type="button" className="cursor-pointer">
                  <span className="font-medium text-[#DA0025]">Forgot Password?</span> 
                </button>
              </Link>
            </div>
          ...
          <div className="flex items-center w-[95%] lg:w-[65%] py-3 border-t-1 border-[#dddddd] mt-6 justify-between">
            <div>
              <p className="text-[#8f8f8f] text-sm md:text-base">Don't have an account?</p>
              <span className="font-medium text-xl md:text-2xl">Sign up</span>
            </div>
            <Link to="/signup">
              <div className="rounded-[50px] p-3 cursor-pointer">
                <svg className="lg:h-[50px] lg:w-[51px] h-[40px] w-[41px]" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="0.5" width="50" height="50" rx="25" fill="#FFD5DC"/>
                  <path d="M34.2071 24.2929C34.5976 24.6834 34.5976 25.3166 34.2071 25.7071L27.8431 32.0711C27.4526 32.4616 26.8195 32.4616 26.4289 32.0711C26.0384 31.6805 26.0384 31.0474 26.4289 30.6569L32.0858 25L26.4289 19.3431C26.0384 18.9526 26.0384 18.3195 26.4289 17.9289C26.8195 17.5384 27.4526 17.5384 27.8431 17.9289L34.2071 24.2929ZM17.5 26C16.9477 26 16.5 25.5523 16.5 25C16.5 24.4477 16.9477 24 17.5 24V26ZM33.5 26H17.5V24H33.5V26Z" fill="#DA0025"/>
                </svg>
              </div>
            </Link>
          </div>
