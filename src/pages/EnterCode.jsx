    ...
    <div className="relative w-full  m-0">
      ...
      <div className="flex w-full h-screen px-4 md:px-15 justify-center items-center">
        <div className="w-full h-[90%] flex flex-col justify-center items-center bg-white rounded-4xl shadow-md">
          <div className="h-[70%] w-[30%] flex flex-col gap-3 justify-center items-center">
            <h1 className="text-[46px] font-[500]">Enter Code</h1>
            <form onSubmit={handleSubmit}>
                <div className="w-[100%] flex gap-4 mb-3">
                    {Array.from({ length: 6 }).map((_, index) => (
                        ...
                        type="number"
                        placeholder="--"
                        className="w-1/6 font-medium border text-center border-gray-400 px-3 py-[5px] md:py-[18px] rounded-md bg-[#f3f3f3] 
