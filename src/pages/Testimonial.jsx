    ...
    <div>
      ...
      <div className="xl:w-[1280px] lg:w-[1080px] md:w-[786px] sm:w-[600px] sm:mx-auto mx-4 ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 sm:my-20 gap-10 my-10">
          ...
          <div className="bg-white rounded-[12px] px-10 py-[34px] ">
            <div className="flex items-center gap-5">
              ...
              <div className="w-[80%]">
                ...
                <p className="sm:text-[16px] text-[12px] text-[#595959]">
                  I love how clean and modern the design of this website is. The
                  colors are vibrant yet not overwhelming, and everything looks
                  crisp and fresh.
                </p>
              </div>
            </div>
