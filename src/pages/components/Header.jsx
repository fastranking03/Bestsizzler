      ...
      <div className="sticky top-0 z-90 sm:block hidden">
        <div className="bg-[#DA0025]  text-white flex items-center justify-between py-2 px-20">
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <Link to="/login" className="flex items-center gap-2" href="">
                <svg
                  width="13"
                  height="16"
                  viewBox="0 0 13 16"
              ...
              <li className="relative menu-drop hover:text-[#DA0025]">
                ...
                <div className="dropdown-content absolute  bg-white text-black shadow-lg rounded mt-2 w-160  z-10  p-5 top-[16px]">
                  <div className="flex flex-wrap gap-9 items-center ">
                    ...
                    >
                      <img
                        src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471937/OBJECTS_buxsga.png"
                        className="w-[50px]"
                        alt=""
                      />
                      DONNER
                    ...
                    >
                      <img
                        src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471936/Frame_cwfw4s.png"
                        className="w-[40px]"
                        alt=""
                      />
                      WRAPS
                    ...
                    >
                      <img
                        src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471936/Group_239205_givbng.png"
                        className="w-[40px]"
                        alt=""
                      />
                      BURGER
                    ...
                    >
                      <img
                        src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471936/Cakes_l97qpi.png"
                        className="w-[48px]"
                        alt=""
                      />
                      DESSERTS
                    ...
                    >
                      <img
                        src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471936/Asset_3_4x_1_gap0o0.png"
                        className="w-[45px]"
                        alt=""
                      />
                      PERI PERI CHICKEN
                    ...
                    >
                      <img
                        src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471936/hand-drawn-fried-chicken-illustration_561641-3588_1_llkwuj.png"
                        className="w-[50px]"
                        alt=""
                      />
                    ...
                    >
                      <img
                        src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471936/plate-with-toast-face-shape-with-apple-table_1_uplmyc.png"
                        className="w-[50px]"
                        alt=""
                      />
                      KIDS MEAL
                    ...
                    >
                      <img
                        src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471936/Group_su4vtw.png"
                        className="w-[36px]"
                        alt=""
                      />
                      DRINKS OPTIONS
