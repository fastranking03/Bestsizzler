  ...
  return (
    <div className="mt-10 relative">
        <div className="absolute z-[-1] lg:top-0 md:top-0 sm:top-0 top-[20px] animate-floating">
            <img 
            className="lg:w-[170px] md:w-[150px] sm:w-[130px]  w-[80px]"
      ...
      <div className="absolute lg:right-40 md:right-30 sm:right-20 right-10 lg:top-[-10px] md:top-[-10px] sm:top-[-20px] top-[-30px] animate-menu-x">
          <img className="lg:w-[170px] md:w-[150px] sm:w-[130px]  w-[100px]" src="https://res.cloudinary.com/dj7wogsju/image/upload/v1741777724/shape_3.png_uwtvwf.png" alt="" />
       </div>
    </div>
  );
}
