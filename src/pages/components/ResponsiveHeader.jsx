                ...
                <Link onClick={navItemToggle} className="text-black cursor-pointer transition-all  hover:bg-[#eee] font-[500] p-3 mb-2 block">
                 ...
                 <ul className={`${navitem ? 'block' : 'hidden'} mt-4`}>
                     ...
                     <Link
                        ...
                        <img src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471937/OBJECTS_buxsga.png" alt="" className="w-[25px] h-[25px]" />
                        DONNER
                      </Link>
                     </li>
                     <li className="mt-1">
                     <Link
                        ...
                        <img src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471936/Frame_cwfw4s.png" alt="" className="w-[25px] h-[25px]" />
                        Wraps
                      </Link>
                     </li>
                     <li className="mt-1">
                     <Link
                        to="#" className="flex hover:bg-[#eee] p-2 text-[15px] gap-2 items-center transition-all font-[600] hover:text-[#eb0029] transform hover:translate-x-2 hover:svg-fill-red mb-2" >
                        <img src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471936/Group_239205_givbng.png" alt="" className="w-[25px] h-[25px]" />
                        Burger
                      </Link>
                     </li>
                     <li className="mt-1">
                     <Link
                        to="#" className="flex hover:bg-[#eee] p-2 text-[15px] gap-2 items-center transition-all font-[600] hover:text-[#eb0029] transform hover:translate-x-2 hover:svg-fill-red mb-2" >
                        <img src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471936/Cakes_l97qpi.png" alt="" className="w-[25px] h-[25px]" />
                       Desserts
                      </Link>
                     </li>
                     <li className="mt-1">
                     <Link
                        to="#" className="flex hover:bg-[#eee] p-2 text-[15px] gap-2 items-center transition-all font-[600] hover:text-[#eb0029] transform hover:translate-x-2 hover:svg-fill-red mb-2" >
                        <img src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471936/Asset_3_4x_1_gap0o0.png" alt="" className="w-[25px] h-[25px]" />
                        Peri Peri Chicken
                      </Link>
                     </li>
                     <li className="mt-1">
                     <Link
                        to="#" className="flex hover:bg-[#eee] p-2 text-[15px] gap-2 items-center transition-all font-[600] hover:text-[#eb0029] transform hover:translate-x-2 hover:svg-fill-red mb-2" >
                        <img src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471936/hand-drawn-fried-chicken-illustration_561641-3588_1_llkwuj.png" alt="" className="w-[25px] h-[25px]" />
                     ...
                     <Link
                        to="#" className="flex hover:bg-[#eee] p-2 text-[15px] gap-2 items-center transition-all font-[600] hover:text-[#eb0029] transform hover:translate-x-2 hover:svg-fill-red mb-2" >
                        <img src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471936/plate-with-toast-face-shape-with-apple-table_1_uplmyc.png" alt="" className="w-[25px] h-[25px]" />
                        Kids Meal
                      </Link>
                     </li>
                     <li className="mt-1">
                     <Link
                        to="#" className="flex hover:bg-[#eee] p-2 text-[15px] gap-2 items-center transition-all font-[600] hover:text-[#eb0029] transform hover:translate-x-2 hover:svg-fill-red mb-2" >
                        <img src="https://res.cloudinary.com/dj7wogsju/image/upload/v1742471936/Group_su4vtw.png" alt="" className="w-[25px] h-[25px]" />
                        Drinks Options
                      </Link>
                     </li>
